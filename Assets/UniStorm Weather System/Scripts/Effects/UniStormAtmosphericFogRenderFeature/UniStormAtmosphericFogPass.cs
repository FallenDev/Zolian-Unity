...
{
    /// <summary>
    /// The pass that handles the atmospheric fog effect.
    /// </summary>
    ...
    public class UniStormAtmosphericFogPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            camera.CalculateFrustumCorners(new Rect(0, 0, 1, 1), camera.farClipPlane, leftStereoscopicEye,
                leftEyeFrustumCorners);
            camera.CalculateFrustumCorners(new Rect(0, 0, 1, 1), camera.farClipPlane,
                Camera.MonoOrStereoscopicEye.Right, rightEyeFrustumCorners);
            ...
            fogMaterial.SetMatrixArray("_FrustumCornersWSArray",
                new Matrix4x4[2] { leftEyeFrustumMatrix, rightEyeFrustumMatrix });

            fogMaterial.SetVector("_CameraWS", camPos);
            fogMaterial.SetVector("_HeightParams",
                new Vector4(settings.height, FdotC, paramK, settings.heightDensity * 0.5f));
            ...
            fogMaterial.SetVector("_SceneFogMode",
                new Vector4((int)sceneMode, settings.useRadialDistance ? 1 : 0, 0, 0));
