...
namespace UniStorm.Effects
{
    public class UniStormCloudShadowsPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            screenSpaceShadowsMaterial.SetFloat("_CloudTexScale",
                settings.CloudTextureScale + (settings.m_CurrentCloudHeight * 0.000001f) * 2);
            ...
            screenSpaceShadowsMaterial.SetVector("_SunDirection",
                new Vector3(settings.ShadowDirection.x, settings.ShadowDirection.y, settings.ShadowDirection.z));
