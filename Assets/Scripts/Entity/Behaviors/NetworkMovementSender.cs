...
namespace Assets.Scripts.Entity.Behaviors
{
    ...
    {
        [Header("Packet Rate & Precision")] [SerializeField]
        private float _sendInterval = 0.1f; // How often to send movement updates
        ...
        private void Update()
        {
            if (_player == null || _player.Client == null) return;
