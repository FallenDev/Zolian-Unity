...
namespace AnyRPG {
    public abstract class NewGameWizardBase : ScriptableWizard, ICreateSceneRequestor {
        ...
        */
        ...
        protected void SetNewGameTitle() {
        ...
        protected virtual bool CheckFilesExist() {
        ...
        protected void ConfigureMainMenuScriptableObjects(string fileSystemGameName) {
        ...
        */
        ...
        protected string Validate(string fileSystemGameName) {
        ...
        protected bool GameFolderExists(string newGameFolder) {
