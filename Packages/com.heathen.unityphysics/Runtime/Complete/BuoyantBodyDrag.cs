...
namespace HeathenEngineering.UnityPhysics
{
    ...
    public class BuoyantBodyDrag : MonoBehaviour
    {
        ...
        public void UpdateDrag(BuoyantBody body, PhysicsData physicsData)
        {
            ...
            {
                physicsData.AttachedRigidbody.linearDamping = (subsurfaceLinearDrag * body.submergedRatio) + ((1f - body.submergedRatio) * surfaceLinearDrag);
                physicsData.AttachedRigidbody.angularDamping = (subsurfaceAngularDrag * body.submergedRatio) + ((1f - body.submergedRatio) * surfaceAngularDrag);
            }
        }
    }
}
